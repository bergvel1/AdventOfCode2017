 ...
 * NULL into the vector if they choose to. We also consider NULL and "" to be
 * equivalent.
 *
 ...
 * can add up to 10 entries and array will not need to be
 * reallocated-- just change 'size'.  When the user wants to add the
 * 11th entry, the array will be reallocated to hold 20 entries. If
 * that fills up, reallocate it to hold 40 entries, and so on.
